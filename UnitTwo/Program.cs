        ...
        static void Main()
        {
            ...
            switch(choice)
            {
                ...
                case "44":
                    ...
                    break;
                case "45":
                    _ = new ExerciseFourtyFive();
                    break;
                case "46":
                    _ = new ExerciseFourtySix();
                    break;
                case "47":
                    _ = new ExerciseFourtySeven();
                    break;
                case "48":
                    _ = new ExerciseFourtyEight();
                    break;
                case "49":
                    _ = new ExerciseFourtyNine();
                    break;
                case "50":
                    _ = new ExerciseFifty();
                    break;
                case "51":
                    _ = new ExerciseFiftyOne();
                    break;
                case "52":
                    _ = new ExerciseFiftyTwo();
                    break;
                default:
                    break;
            }
